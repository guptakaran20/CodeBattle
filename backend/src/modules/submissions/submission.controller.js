...
export const createSubmission = async (req, res, next) => {
    try {
        ...
        const io = getIO();
        const userObj = req.user; // Cast or fetch full user
...
export const runSubmission = async (req, res, next) => {
    try {
...
export const getSubmissionsByBattle = async (req, res, next) => {
    try {
...
export const getSingleSubmission = async (req, res, next) => {
    try {
