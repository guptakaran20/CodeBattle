...
export interface ValidationResult {
  ...
  hiddenCases: { input: string; expectedOutput: string; weight: number; isEdgeCase: boolean; group: string }[];
  errors: string[];
...
export class ImportValidator {
  ...
  async validate(generatorCode: string, referenceSolutionCode: string): Promise<ValidationResult> {
