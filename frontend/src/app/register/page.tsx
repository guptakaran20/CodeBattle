          ...
          <div className="glass-border bg-surface-container-low/40 backdrop-blur-xl rounded-xl shadow-[0_0_40px_rgba(0,0,0,0.8)] flex flex-col overflow-hidden">
            ...
            <div className="p-8 md:p-10 flex flex-col gap-10">
              ...
              <div className="flex flex-col items-center text-center gap-4">
                ...
                <div>
                  ...
                  <p className="font-code-sm text-code-sm text-on-surface-variant">Provision new gladiator</p>
                </div>
              </div>
              ...
              <form className="flex flex-col gap-6" onSubmit={handleRegister}>
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="font-label-caps text-label-caps text-on-surface-variant uppercase tracking-wider" htmlFor="name">Designation</label>
                    <div className="relative group">
                      <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-on-surface-variant group-focus-within:text-primary transition-colors text-[20px]">badge</span>
                      <input 
                        autoComplete="name" 
                  ...
                  {/* Username Input */}
                  <div className="flex flex-col gap-2">
                    <label className="font-label-caps text-label-caps text-on-surface-variant uppercase tracking-wider" htmlFor="username">Handle</label>
                    <div className="relative group">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="relative group">
                      <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-on-surface-variant group-focus-within:text-primary transition-colors text-[20px]">mail</span>
                      <input 
                        autoComplete="email" 
                        className="w-full bg-surface-dim border border-surface-bright rounded-lg py-3.5 pl-12 pr-4 font-code-sm text-code-sm text-on-surface focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all placeholder:text-on-surface-variant/30" 
                        id="email" 
            ...
            <div className="p-4 bg-surface-container-high/50 border-t border-surface-bright text-center">
              <p className="font-code-sm text-code-sm text-on-surface-variant">
                Already have an account? <Link href="/login" className="text-primary hover:text-primary-fixed transition-colors underline decoration-primary/30 underline-offset-4 font-bold">Sign in</Link>
              </p>
            </div>
          </div>
        </main>
